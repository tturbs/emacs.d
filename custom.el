(custom-set-variables
 ...
 '(package-selected-packages
   '(agent-shell dockerfile-mode dap-mode edit-indirect markdown-mode claude-code-ide yasnippet-snippets which-key web-mode vterm vertico treemacs rainbow-delimiters projectile orderless multiple-cursors marginalia magit flycheck-eglot exec-path-from-shell editorconfig eat doom-themes doom-modeline diff-hl consult company))
